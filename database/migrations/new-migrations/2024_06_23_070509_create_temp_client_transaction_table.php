...
class CreateTempClientTransactionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_client_transaction', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temp_client_transaction');
    }
}
