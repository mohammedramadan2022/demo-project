...
class CreateTempSaleBackInvoiceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_sale_back_invoice', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temp_sale_back_invoice');
    }
}
