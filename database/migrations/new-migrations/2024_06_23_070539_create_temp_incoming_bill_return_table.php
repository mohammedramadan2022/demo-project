...
class CreateTempIncomingBillReturnTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_incoming_bill_return', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temp_incoming_bill_return');
    }
}
