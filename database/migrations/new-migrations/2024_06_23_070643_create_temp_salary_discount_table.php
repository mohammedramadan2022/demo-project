...
class CreateTempSalaryDiscountTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_salary_discount', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temp_salary_discount');
    }
}
