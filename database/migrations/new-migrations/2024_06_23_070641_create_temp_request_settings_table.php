...
class CreateTempRequestSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_request_settings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('temp_request_settings');
    }
}
