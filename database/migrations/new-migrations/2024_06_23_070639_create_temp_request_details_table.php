...
class CreateTempRequestDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_request_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temp_request_details');
    }
}
