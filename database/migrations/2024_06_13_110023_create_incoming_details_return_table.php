...
class CreateIncomingDetailsReturnTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('incoming_details_return', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('incoming_details_return');
    }
}
